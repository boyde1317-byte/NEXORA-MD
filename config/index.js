...
export const config = {
  botName: brand.name,
  owner: ["1234567890"], // Owner phone numbers without @s.whatsapp.net
  prefix: ["!", ".", "/"],
  pairing: {
    enabled: true, // Set to true to use pairing code, false for QR code terminal
    phoneNumber: "1234567890" // Default phone number for pairing code (must include country code, e.g., 44xxx or 1xxx)
  },
  sessionPath: "./session",
  reconnectLimit: 5,
